...
start_services() {
    ...
    open_browser "http://localhost:5175"
    
    echo ""
    print_success "🚀 AI Hedge Fund web application is now running!"
    print_success "🌐 Browser should open automatically to http://localhost:5175"
    echo ""
    print_status "Frontend (Web Interface): http://localhost:5175"
